...
const chinaAIFeatures = [
  ...
  },
  {
    ...
    benefit: `Personalized action plans from ${chinaCitiesFull.length} China region cities`
  },
  {
    id: 'report_generator',
      ...
      <div className="p-5">
        ...
        {feature.status === 'available' ? (
          <button
            ...
            className="w-full py-2.5 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-lg font-medium hover:from-red-700 hover:to-rose-700 transition-all flex items-center justify-center space-x-2"
          >
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">AI-powered analysis for China region cities</p>
            </div>
          </div>
        </div>
              ...
              <div className="p-4 bg-red-50 rounded-lg">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-red-700">
                    {city?.name || 'All China Region Cities'}
                  </span>
                </div>
        ...
        <div className="p-6 border-t border-gray-100 flex space-x-3">
          ...
          {!analyzing && !results && (
            <button
              ...
              className="flex-1 py-2.5 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-lg font-medium hover:from-red-700 hover:to-rose-700 transition-all flex items-center justify-center space-x-2"
            >
              <Sparkles className="w-4 h-4" />
...
function ChinaAIAutomation() {
  const { selectedId } = useOrganization()
  const [showModal, setShowModal] = useState(false)
  const [activeFeature, setActiveFeature] = useState(null)

  const selectedCity = chinaCitiesFull.find(c => c.id === selectedId)
  ...
  const stats = {
    totalCities: chinaCitiesFull.length,
    withEmissions: chinaCitiesFull.filter(c => c.q3_1_3?.length > 0).length,
    withHazards: chinaCitiesFull.filter(c => c.q2_2?.length > 0).length,
    withTargets: chinaCitiesFull.filter(c => c.q6_1_1?.length > 0).length
  }
    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-red-100">
              Transform China region city climate reporting with intelligent automation
            </p>
          </div>
          <div className="text-right">
            ...
            <span className="text-red-200">4 Available Now</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          ...
          <p className="text-2xl font-bold text-red-600">{stats.withEmissions}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          <div className="flex items-center gap-2 text-gray-500 text-sm mb-1">
          ...
          <p className="text-2xl font-bold text-rose-600">{stats.withHazards}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          <div className="flex items-center gap-2 text-gray-500 text-sm mb-1">
...
export default ChinaAIAutomation
