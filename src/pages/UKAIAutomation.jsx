...
const ukAIFeatures = [
  ...
  },
  {
    ...
    benefit: 'Personalized action plans from 59 UK entities'
  },
  {
    id: 'report_generator',
      ...
      <div className="p-5">
        ...
        {feature.status === 'available' ? (
          <button
            ...
            className="w-full py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:from-indigo-700 hover:to-purple-700 transition-all flex items-center justify-center space-x-2"
          >
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">AI-powered analysis for UK cities</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 border-t border-gray-100 flex space-x-3">
          ...
          {!analyzing && !results && (
            <button
              ...
              className="flex-1 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:from-indigo-700 hover:to-purple-700 transition-all flex items-center justify-center space-x-2"
            >
              <Sparkles className="w-4 h-4" />
...
function UKAIAutomation() {
  const { selectedId } = useOrganization()
  const [showModal, setShowModal] = useState(false)
  const [activeFeature, setActiveFeature] = useState(null)

  const selectedCity = ukCitiesFull.find(c => c.id === selectedId)
  ...
  const stats = {
    totalCities: ukCitiesFull.length,
    withEmissions: ukCitiesFull.filter(c => c.q3_1_3?.length > 0).length,
    withHazards: ukCitiesFull.filter(c => c.q2_2?.length > 0).length,
    withTargets: ukCitiesFull.filter(c => c.q6_1_1?.length > 0).length
  }
    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-indigo-100">
              Transform UK city climate reporting with intelligent automation
            </p>
          </div>
          <div className="text-right">
            ...
            <span className="text-indigo-200">4 Available Now</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          ...
          <p className="text-2xl font-bold text-indigo-600">{stats.withEmissions}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          <div className="flex items-center gap-2 text-gray-500 text-sm mb-1">
