  ...
  if (!isIndiaCity || !city) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-600">Select an India city to view AI insights</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <p className="text-3xl font-bold text-orange-600">{totalActions}</p>
            <p className="text-sm text-gray-600">Climate Actions</p>
          </div>
          <div className="text-center p-4 bg-amber-50 rounded-lg">
            <p className="text-3xl font-bold text-amber-600">{totalTargets}</p>
...
export default IndiaAIAutomation
